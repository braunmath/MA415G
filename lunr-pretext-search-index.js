...
},
{
  ...
  "number": "3.4.1",
  "title": "",
  "body": "  Given a finite graph , an Eulerian circuit is a circuit in that crosses every edge exactly one time. If has an Eulerian circuit, then we say that is an Eulerian graph .   "
},
{
