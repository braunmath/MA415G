...
},
{
  ...
  "number": "10.0.37",
  "title": "P31.",
  "body": " P31  Given an Erdos-Renyi random graph , let be the random variable that counts the number of paths of length in (that is, sequences of three distinct vertices such that and are edges in ). Find the expected value of .  "
},
{
  "id": "ch-homework-38",
  "level": "2",
